...
public class TeamMateDetailActivity extends BaseActivity implements TeamMateDetailScreen {
  ...
  @BindView(R.id.team_mate_detail_toolbar)
  Toolbar toolbarView;
  @BindView(R.id.team_mate_detail_avatar)
  ImageView avatarView;
  @BindView(R.id.team_mate_detail_github)
  TextView githubView;
  @BindView(R.id.team_mate_detail_location)
  ImageView locationView;
  @BindView(R.id.team_mate_detail_role)
  TextView roleView;
  @BindView(R.id.team_mate_detail_languages)
  TextView languagesView;
  @BindView(R.id.team_mate_detail_tags)
  TextView tagsView;
  @BindView(R.id.team_mate_detail_status)
  EditText statusField;

  public static Intent intent(Context context, User user) {
    Intent intent = new Intent(
      context,
      TeamMateDetailActivity.class
    );
    intent.putExtra(
      MATE_EXTRA,
      user
  ...
  private void configure(final Toolbar toolbarView) {
    ...
    toolbarView.setNavigationIcon(ContextCompat.getDrawable(
      this,
  ...
  public void updateList(final String status, final User user) {
    final User newUser = BasicUser.create(
      user.name(),
      user.avatar(),
      user.github(),
      user.role(),
    ...
    setResult(
      RESULT_OK,
      TeamListActivity.updateIntent(newUser)
    );
    finish();
  }
